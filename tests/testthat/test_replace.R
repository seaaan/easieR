...
test_that("Correct error message is generated with replacement of length > 1", {
   expected <- "Vector 'example' must contain exactly one element, but contains 2."
   example <- c("a", "b")
   expect_that(replace_value(1:3, replacement = example, value = "x"), 
      throws_error(expected))
})
...
test_that("Correct error message is generated with replacement of length 0", {
   expected <- "Vector 'example' must contain exactly one element, but contains 0."
   example <- c()
   expect_that(replace_value(c(1:3, NA), replacement = example, value = "x"), 
      throws_error(expected))
})
...
test_that("Correct error message is generated with value of length > 1", {
   expected <- "Vector 'example' must contain exactly one element, but contains 2."
   example <- c("a", "b")
   expect_that(replace_value(1:3, replacement = "a", value = example), 
      throws_error(expected))
})
...
test_that("Correct error message is generated with value of length 0", {
   expected <- "Vector 'example' must contain exactly one element, but contains 0."
   example <- c()
   expect_that(replace_value(c(1:3, NA), replacement = "x", value = example), 
      throws_error(expected))
})
...
test_that("Correct warning is produced with no matches", {
   ...
   expect_that(replace_value(1:3, "x", "a"), gives_warning(expected))
})

test_that("No warning is produced with no matches but warn = FALSE", {
   expect_that(replace_value(1:3, "x", "a", warn = FALSE), equals(1:3))
})

test_that("Correct output with 1 match", {
   expect_that(replace_value(c(1:3, "a"), replacement = "x", "a"), 
      equals(c(1:3, "x")))
})

test_that("Correct output with multiple matches", {
   expect_that(replace_value(c("a", 1:3, "a", "y", "a"), replacement = "x", "a"), 
      equals(c("x", 1:3, "x", "y", "x")))
})
...
test_that("Correct output with factor and multiple matches", {
   vec <- c("a", 1:3, "a", "y", "a")
   vec <- factor(vec)
   expect_that(replace_value(vec, replacement = "x", "a"), 
      equals(factor(c("x", 1:3, "x", "y", "x"))))
})
...
test_that("Correct error message is generated with replacement of length > 1", {
   expected <- "Vector 'example' must contain exactly one element, but contains 2."
   example <- c("a", "b")
   expect_that(replace_regex(1:3, replacement = example, regex = "x"), 
      throws_error(expected))
})
...
test_that("Correct error message is generated with replacement of length 0", {
   expected <- "Vector 'example' must contain exactly one element, but contains 0."
   example <- c()
   expect_that(replace_regex(c(1:3, NA), replacement = example, regex = "x"), 
      throws_error(expected))
})
...
test_that("Correct error message is generated with value of length > 1", {
   expected <- "Vector 'example' must contain exactly one element, but contains 2."
   example <- c("a", "b")
   expect_that(replace_regex(1:3, replacement = "a", regex = example), 
      throws_error(expected))
})
...
test_that("Correct error message is generated with value of length 0", {
   expected <- "Vector 'example' must contain exactly one element, but contains 0."
   example <- c()
   expect_that(replace_regex(c(1:3, NA), replacement = "x", regex = example), 
      throws_error(expected))
})

test_that("Correct warning is produced with no matches", {
   expected <- "Vector contains no matching values, so nothing will be replaced."
   expect_that(replace_regex(1:3, "x", "a"), gives_warning(expected))
})

test_that("No warning is produced with no matches but warn = FALSE", {
   expect_that(replace_regex(1:3, "x", "a", warn = FALSE), equals(1:3))
})

test_that("Correct output with 1 match", {
   expect_that(replace_regex(c(1:3, "absolutely"), replacement = "x", "a."), 
      equals(c(1:3, "x")))
})
...
test_that("Correct output with factor and multiple matches", {
   ...
   vec <- factor(vec)
   expect_that(replace_regex(vec, replacement = "x", "a."), 
...
test_that("Correct error message is generated with unequal length vectors", {
   ...
   rep <- c("a", "b")
   val <- 1:3
   expect_that(replace_values(1:100, replacements = rep, values = val), 
      throws_error(expected))
})
...
test_that("Correct warning is produced with no matches", {
   ...
   expect_that(replace_values(x, "zzz", y), gives_warning(expected))
})
...
test_that("No warning is produced with no matches but warn = FALSE", {
   ...
   expect_that(replace_values(x, "zzz", y, warn = FALSE), equals(1:3))
})

test_that("Correct output with 1 match", {
   expect_that(replace_values(10:30, c("a", "b"), 30:31), 
      equals(c(10:29, "a")))
})

test_that("Correct output with 2 matches", {
   expect_that(replace_values(1:3, c("a", "b"), 1:2), 
      equals(c("a", "b", 3)))
})

test_that("Correct output with 2 matches and factor", {
   input <- factor(1:3)
   expect_that(replace_values(input, c("a", "b"), 1:2), 
